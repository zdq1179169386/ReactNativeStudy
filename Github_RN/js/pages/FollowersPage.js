...
//我的粉丝
class FollowersPage extends Component<Props> {
    constructor(props) {
        super(props);
        this.page = 1
        this.state = {
    ...
    _loadData(loadMore = false) {
        ...
        const {getUserFollower} = this.props;
        getUserFollower(user.login, this.page, (data) => {
            if (loadMore){
    ...
    render() {
        ...
        let navigationBar = <NavigationBar title={Ii8n('followers')} statusBar={statusBar}
...
const mapDispatchToProps = dispatch => ({
    getUserFollower: (username, page, callback) => dispatch(actions.getUserFollower(username, page, callback))
})
